...
export default function CirclesPageClient({ steps, circles }: Props) {
  ...
  if (isLoggedIn) {
    return (
      <>
        {/* Logged-in hero */}
        <div className="bg-secondary px-4 py-14 text-center text-white md:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base font-light text-white/75">
          ...
          <a
            ...
            className="mt-8 inline-block rounded bg-primary px-8 py-3 text-sm font-bold text-white
  ...
  return (
    <>
      ...
      <div
        ref={heroRef}
        className="bg-secondary px-4 py-16 text-center text-white md:px-8 md:py-20"
      >
        <h1 className="font-display text-4xl font-bold leading-tight md:text-6xl">
          Lean In Circles
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-lg font-light text-white/75">
